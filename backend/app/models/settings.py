...
class SystemSettingsBase(SQLModel):
    ...
    gmail_app_password_encrypted: Optional[str] = Field(default=None)
    gmail_client_id_encrypted: Optional[str] = Field(default=None)
    gmail_client_secret_encrypted: Optional[str] = Field(default=None)
