...
export const BACKEND_URL = isLocal ? 'http://127.0.0.1:8000' : 'https://aduanflow-backend-n1in.onrender.com';
export const API_BASE = isLocal ? '' : 'https://aduanflow-backend-n1in.onrender.com';
